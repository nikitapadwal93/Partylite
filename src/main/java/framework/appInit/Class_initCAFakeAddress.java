...
public class Class_initCAFakeAddress extends ImplClass_SAF_V_0_2 {
...
//	public Properties countryList = new Properties();
	...
	public Class_initCAFakeAddress() throws FileNotFoundException, IOException {
		super();
	...
	public void beforeMethod(){
		...
		try {
			fis = new FileInputStream("./Properties/CAAddress.properties");
