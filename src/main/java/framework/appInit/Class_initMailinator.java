...
public class Class_initMailinator extends ImplClass_SAF_V_0_2 {
...
//	public Properties countryList = new Properties();
	...
	public Class_initMailinator() throws FileNotFoundException, IOException {
		super();
	...
	public void beforeMethod(){
		...
		try {
			fis = new FileInputStream("./Properties/Mail.properties");
