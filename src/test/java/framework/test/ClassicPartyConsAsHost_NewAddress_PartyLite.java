...
public class ClassicPartyConsAsHost_NewAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public ClassicPartyConsAsHost_NewAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setData_CPCHNA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Classic Party ConsAsHost NewAddress";
		tcDescription = "Signing in of Consultant and creating a classic party by assigning consultant as host - new address";
		category = "Smokes";
		authors = "Anand";
	...
	public void classicConsAsHost_NewAddress(String consultant_uname, String consultant_password, String partyName, 
