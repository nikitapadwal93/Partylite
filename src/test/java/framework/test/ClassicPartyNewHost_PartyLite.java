...
public class ClassicPartyNewHost_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyNewHost_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPNH(@Optional String paramCountry) {
		...
		tcName = "Classic Party NewHost";
		tcDescription = "Signing in of Consultant and creating a classic party using new host";
	...
	public void classicPartyNewHost(String consultant_uname, String consultant_password, String partyName, 
