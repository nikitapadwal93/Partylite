...
public class ClassicPartyOrderRC_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrderRC_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataPORC(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a classic party with empty host order";
