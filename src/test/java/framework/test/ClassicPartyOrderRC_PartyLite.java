...
public class ClassicPartyOrderRC_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrderRC_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataPORC(@Optional String paramCountry) {
		tcName = "Classic Party Order";
		tcDescription = "Creating a final party order for a classic party - FR - RC";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "ClassicPTRC_PL";
		country = paramCountry;
		
	}
	
	@Test(groups= {"PEX", "Smokes"}, dataProvider="CreatePartyDetails")
	public void createPartyOrderRC(String consultant_uname, String consultant_password, String partyName, 
