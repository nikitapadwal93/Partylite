...
public class ClassicPartyOrderShipToCons_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrderShipToCons_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOSTC(@Optional String paramCountry) {
		tcName = "Classic Party Order";
		tcDescription = "Creating a final party order for a classic party - Ship to Consultant with empty host order";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "ClassicPT_SC_PL";
