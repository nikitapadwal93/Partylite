...
public class ClassicPartyOrderShipToCons_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrderShipToCons_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOSTC(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a classic party - Ship to Consultant";
