...
public class ClassicPartyOrderShipToHost_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrderShipToHost_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOSTH(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a classic party - Ship to Host";
