...
public class ClassicPartyOrder_FR_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrder_FR_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOFR(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a classic party - FR";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "ClassicPT_FR_PL";
	...
	public void createPartyOrderFR(String consultant_uname, String consultant_password, String partyName, 
