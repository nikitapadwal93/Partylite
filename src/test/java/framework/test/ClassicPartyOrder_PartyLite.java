...
public class ClassicPartyOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPO(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a classic party";
