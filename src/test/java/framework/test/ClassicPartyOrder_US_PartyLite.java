...
public class ClassicPartyOrder_US_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public ClassicPartyOrder_US_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOUS(@Optional String paramCountry) {
		tcName = "Classic Party Order US";
		tcDescription = "Creating a final party order for a classic party US";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "ClassicPTUS_PL";
