...
public class ClassicPartyPrevHost_HostAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public ClassicPartyPrevHost_HostAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPPHA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Classic Party PrevHost_HostAddress";
		tcDescription = "Signing in of Consultant and creating a classic party by previous host - host address";
	...
	public void classicPartyPrevHost_HostAddress(String consultant_uname, String consultant_password, String partyName, 
