...
public class CollectivePartyConsAsHost_HostAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public CollectivePartyConsAsHost_HostAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCoPCHA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Collective Party ConsAsHost_HostAddress";
		tcDescription = "Signing in of Consultant and creating a collective party by assigning consultant as host - host address";
		
		authors = "Anand";
		testNodes = "Consultant signing-in and creating a party";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Collective_ConsAsHost_HA_PL";
		country = paramCountry;
	}
	
	@Test(groups= {"PEX", "Smokes"}, dataProvider="CreatePartyDetails")
	public void collectiveParty_HostAddress(String consultant_uname, String consultant_password, String partyName, 
