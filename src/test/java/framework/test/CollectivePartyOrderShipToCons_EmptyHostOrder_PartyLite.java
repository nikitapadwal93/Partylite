...
public class CollectivePartyOrderShipToCons_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public CollectivePartyOrderShipToCons_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCoPOSTC(@Optional String paramCountry) {
		tcName = "Collective Party Order";
		tcDescription = "Creating a final party order for a collective party - Ship to Consultant with empty host order";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "CollectivePT_SC_PL";
