...
public class CollectivePartyOrderShipToCons_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public CollectivePartyOrderShipToCons_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCoPOSTC(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a collective party - Ship to Consultant";
