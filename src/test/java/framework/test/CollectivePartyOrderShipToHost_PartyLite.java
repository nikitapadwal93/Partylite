...
public class CollectivePartyOrderShipToHost_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public CollectivePartyOrderShipToHost_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCoPOSTH(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a collective party - Ship to Host";
