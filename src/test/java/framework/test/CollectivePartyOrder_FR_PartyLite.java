...
public class CollectivePartyOrder_FR_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public CollectivePartyOrder_FR_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPOFR(@Optional String paramCountry) {
		tcName = "Collective Party Order -FR";
		tcDescription = "Creating a final party order for a collective party - FR";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "CollectivePT_FR_PL";
		country = paramCountry;
		
	}
	
	@Test(groups= {"PEX", "Smokes"}, dataProvider="CreatePartyDetails")
	public void createCollectivePartyOrderFR(String consultant_uname, String consultant_password, String partyName, 
