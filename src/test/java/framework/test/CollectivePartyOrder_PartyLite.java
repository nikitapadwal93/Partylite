...
public class CollectivePartyOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public CollectivePartyOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCPO(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a collective party";
