...
public class CreatePaperOrder_PartyLite2 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite2() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr2(@Optional String paramCountry) {
