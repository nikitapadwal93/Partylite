...
public class CreatePaperOrder_PartyLite3 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite3() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr3(@Optional String paramCountry) {
