...
public class CreatePaperOrder_PartyLite5 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite5() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr5(@Optional String paramCountry) {
