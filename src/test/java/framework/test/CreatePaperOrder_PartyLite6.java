...
public class CreatePaperOrder_PartyLite6 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite6() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr6(@Optional String paramCountry) {
