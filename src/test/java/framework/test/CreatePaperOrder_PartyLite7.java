...
public class CreatePaperOrder_PartyLite7 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite7() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr7(@Optional String paramCountry) {
