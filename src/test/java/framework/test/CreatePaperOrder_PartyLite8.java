...
public class CreatePaperOrder_PartyLite8 extends Class_initEcomPrac{
	public String country;
	
	public CreatePaperOrder_PartyLite8() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCParOr8(@Optional String paramCountry) {
