...
public class Create_NewRealUserAccount_PartyLite extends Class_initEcomPrac {
	public String country;

	public Create_NewRealUserAccount_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataCNRUA(@Optional String paramCountry) {
		tcName = "Create_NewRealUserAccount";
		tcDescription = "New real user account creation";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Account creation - new real user";
		ExcelFileName = "PartyLite_Smokes_Data";
		sheetName = "CreateAccount_RealUser_PL";
