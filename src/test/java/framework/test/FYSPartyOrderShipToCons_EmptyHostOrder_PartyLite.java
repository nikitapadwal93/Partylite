...
public class FYSPartyOrderShipToCons_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrderShipToCons_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSSTC(@Optional String paramCountry) {
		tcName = "FYS Party Order";
		tcDescription = "Creating a final party order for a FYS party - Ship to Consultant with empty host order";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "FYSPT_SC_PL";
