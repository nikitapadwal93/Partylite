...
public class FYSPartyOrderShipToCons_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrderShipToCons_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSSTC(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a FYS party - Ship to Consultant";
