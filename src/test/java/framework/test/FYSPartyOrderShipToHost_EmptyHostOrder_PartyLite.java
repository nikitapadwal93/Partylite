...
public class FYSPartyOrderShipToHost_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrderShipToHost_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPOSTH(@Optional String paramCountry) {
		tcName = "FYS Party Order";
		tcDescription = "Creating a final party order for a FYS party - Ship to Host with empty host order";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "FYSPT_SH_PL";
