...
public class FYSPartyOrderShipToHost_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrderShipToHost_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPOSTH(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a FYS party - Ship to Host";
