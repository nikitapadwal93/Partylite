...
public class FYSPartyOrder_CA_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrder_CA_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPOCA(@Optional String paramCountry) {
		tcName = "FYS Party Order Cananda";
		tcDescription = "Creating a final party order for a FYS party Canada";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "FYSPTCA_PL";
	...
	public void createPartyOrder(String consultant_uname, String consultant_password, String partyName, 
		...
		try {
			...
			.clickRadioDebit()
			.enterCustomerAddress1(country, shipAddrLine1)
			.enterCustomerCity(country, shipAddrcity)
			.enterCustomerZipCode(country, shipAddrpostcode)
			.clickUpdateButton()
			.clickAcceptTerms()
