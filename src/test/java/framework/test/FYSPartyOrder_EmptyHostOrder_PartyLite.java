...
public class FYSPartyOrder_EmptyHostOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrder_EmptyHostOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPO(@Optional String paramCountry) {
		tcName = "FYS Party Order";
		tcDescription = "Creating a final party order for a FYS party with empty host order";
