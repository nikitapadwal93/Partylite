...
public class FYSPartyOrder_FR_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrder_FR_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPOFR(@Optional String paramCountry) {
		tcName = "FYS Party Order - FR";
		tcDescription = "Creating a final party order for a FYS party - FR";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "FYSPT_FR_PL";
	...
	public void createFYSPartyOrderFR(String consultant_uname, String consultant_password, String partyName, 
