...
public class FYSPartyOrder_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrder_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPO(@Optional String paramCountry) {
		...
		tcDescription = "Creating a final party order for a FYS party";
