...
public class FYSPartyOrder_US_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public FYSPartyOrder_US_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFYSPOUS(@Optional String paramCountry) {
		tcName = "FYS Party Order US";
		tcDescription = "Creating a final party order for a FYS party US";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "Party order";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "FYSPTUS_PL";
