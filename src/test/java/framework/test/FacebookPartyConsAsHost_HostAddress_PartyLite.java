...
public class FacebookPartyConsAsHost_HostAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public FacebookPartyConsAsHost_HostAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFBPCH_HA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Facebook Party ConsAsHost_HostAddress";
		tcDescription = "Signing in of Consultant and creating a facebook party by assigning consultant as host - host address";
		
		authors = "Anand";
		testNodes = "Consultant signing-in and creating a party";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Facebook_ConsAsHost_HA_PL";
		country = paramCountry;
	}
	
	@Test(groups= {"PEX", "Smokes"}, dataProvider="CreatePartyDetails")
	public void facebookPartyConsAsHost_HostAddress(String consultant_uname, String consultant_password, String partyName, 
