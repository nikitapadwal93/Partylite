...
public class FacebookPartyConsAsHost_NewAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public FacebookPartyConsAsHost_NewAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFBPCH_NA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Facebook Party ConsAsHost_NewAddress";
		tcDescription = "Signing in of Consultant and creating a facebook party by assigning consultant as host - new address";
		
		authors = "Anand";
		testNodes = "Consultant signing-in and creating a party";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Facebook_ConsAsHost_NA_PL";
		country = paramCountry;
	}
	
	@Test(groups= {"PEX", "Smokes"}, dataProvider="CreatePartyDetails")
	public void facebookPartyConsAsHost_NewAddress(String consultant_uname, String consultant_password, String partyName, 
			 String partyDate, String partyTime,String shipAddrLine1, String shipAddrLine2,String shipAddrcity , String shipAddrcountry, 
