...
public class FacebookPartyPrevHost_PrevAddress_PartyLite extends Class_initEcomPrac{
	public String country;

	public FacebookPartyPrevHost_PrevAddress_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataFBPPH_PA(@Optional String paramCountry) {
		category = "Smokes_" +paramCountry;
		tcName = "Facebook Party PrevHost_PrevAddress";
		tcDescription = "Signing in of Consultant and creating a facebook party by assigning previous host - previous address";
		
		authors = "Anand";
		testNodes = "Consultant signing-in and creating a party";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Facebook_PrevHost_PA_PL";
