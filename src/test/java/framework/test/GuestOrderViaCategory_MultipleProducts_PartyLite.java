...
public class GuestOrderViaCategory_MultipleProducts_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public GuestOrderViaCategory_MultipleProducts_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOVCMP(@Optional String paramCountry) {
		tcName = "GuestOrder";
		tcDescription = "placing order in eShop by guest with multiple products";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "guest order in eshop";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "GuestOrderMP_PL";
		country = paramCountry;
		
	}
	
	@Test(groups= {"eShop", "Smokes"}, dataProvider="GuestOrder")
	public void createGuestOrderMP(String product_count,String email,String firstname,
		...
		try {
			...
			.clickToAllowCookie()
			.addRandomProducts(product_count)
			.clickBtnMiniCart()
			.clickBtnViewBasket()
			.clickGoToCheckout()
