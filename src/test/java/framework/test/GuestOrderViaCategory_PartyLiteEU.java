...
public class GuestOrderViaCategory_PartyLiteEU extends Class_initEcomPrac{
	public String country;
	
	public GuestOrderViaCategory_PartyLiteEU() throws FileNotFoundException, IOException {
		super();
