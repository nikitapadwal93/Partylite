...
public class GuestOrderViaCategory_PayPal_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public GuestOrderViaCategory_PayPal_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOVCPAYPAL(@Optional String paramCountry) {
		tcName = "GuestOrder";
		tcDescription = "placing order in eShop by guest via paypal";
