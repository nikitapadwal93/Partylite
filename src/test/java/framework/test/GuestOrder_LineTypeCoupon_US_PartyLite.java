...
public class GuestOrder_LineTypeCoupon_US_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public GuestOrder_LineTypeCoupon_US_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOLTCOUPONUS(@Optional String paramCountry) {
		tcName = "GuestOrder";
		...
		sheetName = "LineType_Coupon_US_PL";
