...
public class GuestOrder_LineType_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public GuestOrder_LineType_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOLT(@Optional String paramCountry) {
		tcName = "GuestOrder";
		tcDescription = "placing order in eShop by guest Linetype orders";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "guest order in eshop";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "OrderLineType_PL";
		country = paramCountry;
		
	}
	
	@Test(groups= {"eShop", "Smokes"}, dataProvider="GuestOrder")
	public void createGuestOrderLT(String SKU,String qty,String email,String firstname,
