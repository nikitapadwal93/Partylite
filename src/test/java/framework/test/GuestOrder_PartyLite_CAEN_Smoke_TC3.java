...
public class GuestOrder_PartyLite_CAEN_Smoke_TC3 extends Class_initEcomPrac{
	public String country;
	
	public GuestOrder_PartyLite_CAEN_Smoke_TC3() throws FileNotFoundException, IOException {
		super();
