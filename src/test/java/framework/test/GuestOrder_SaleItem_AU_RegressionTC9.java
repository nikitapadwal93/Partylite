...
public class GuestOrder_SaleItem_AU_RegressionTC9 extends Class_initEcomPrac{
	public String country;
	
	public GuestOrder_SaleItem_AU_RegressionTC9() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOGC(@Optional String paramCountry) {
		tcName = "GuestOrder_SaleItem_AU_RegressionTC9";
		tcDescription = "placing order in eShop by guest (Order sale item)";
		category = "Smokes_"+paramCountry;
		authors = "Nikhil";
		testNodes = "guest order in eshop";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Regression_TC9";
		country = paramCountry;
		
	}
	
	@Test(groups= {"eShop", "Smokes"}, dataProvider="GuestOrder")
	public void guestOrderApplyGC(String SKU,String qty, String SKU2, String coupon_code,
