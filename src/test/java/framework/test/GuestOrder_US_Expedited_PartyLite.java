...
public class GuestOrder_US_Expedited_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public GuestOrder_US_Expedited_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOUSE(@Optional String paramCountry) {
		tcName = "GuestOrder";
		tcDescription = "placing order in eShop by guest US Expedited";
		category = "Smokes_"+paramCountry;
		authors = "Anand";
		testNodes = "guest order in eshop";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "GuestOrderUSES_PL";
