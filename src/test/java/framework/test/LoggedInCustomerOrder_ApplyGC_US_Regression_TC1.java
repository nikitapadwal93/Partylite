...
public class LoggedInCustomerOrder_ApplyGC_US_Regression_TC1 extends Class_initEcomPrac{
	public String country;
	
	public LoggedInCustomerOrder_ApplyGC_US_Regression_TC1() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataLCO(@Optional String paramCountry) {
		tcName = "Regression_TC-1: US - Affiliate Site -Apply GC- Logged in Checkout";
		tcDescription = "placing order in Affiliate site by a customer";
		category = "Regression_"+paramCountry;
		authors = "Saravanan";
		testNodes = "Logged In customer order checkout by Applying GC";
		ExcelFileName="PartyLite_Smokes_Data";
		sheetName = "Regression_TC1";
	...
	public void loggedInCustomerOrder(String fname, String lname,String email, String confemail, String password,  String ContentForVerification,String SKU,String qty,
			 String giftcardnumber, String giftcardpin,String address1,String zipcode,String city, String state, String phone,
