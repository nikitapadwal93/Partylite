...
public class LoggedInCustomerOrder_PartyLite_Smoke_TC2 extends Class_initEcomPrac{
	public String country;
	
	public LoggedInCustomerOrder_PartyLite_Smoke_TC2() throws FileNotFoundException, IOException {
		super();
