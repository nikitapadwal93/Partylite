...
public class LoggedInCustomer_CA_RedeemAward_RegressionTC8 extends Class_initEcomPrac{
	public String country;
	
	public LoggedInCustomer_CA_RedeemAward_RegressionTC8() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataGOGC(@Optional String paramCountry) {
		...
		sheetName = "Regression_TC8";
		country = paramCountry;
		
	}
	
	@Test(groups= {"eShop", "Smokes"}, dataProvider="GuestOrder")
	public void guestOrderApplyGC(String customer_email,String customer_password,String ContentToVerify, 
			String SKU,String giftcardnumber,String giftcardpin,String email,String firstname,
