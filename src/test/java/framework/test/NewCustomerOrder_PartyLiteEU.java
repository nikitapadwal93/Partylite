...
public class NewCustomerOrder_PartyLiteEU extends Class_initEcomPrac {
	public String country;

	public NewCustomerOrder_PartyLiteEU() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataNCO(@Optional String paramCountry) {
