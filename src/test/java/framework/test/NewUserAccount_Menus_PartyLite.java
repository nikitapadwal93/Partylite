...
public class NewUserAccount_Menus_PartyLite extends Class_initEcomPrac {
	public String country;

	public NewUserAccount_Menus_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataNEWUSERACC(@Optional String paramCountry) {
