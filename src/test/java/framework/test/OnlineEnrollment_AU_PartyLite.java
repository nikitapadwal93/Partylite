...
public class OnlineEnrollment_AU_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_AU_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		tcName = "Online Enrollment AU";
		tcDescription = "consultant enrollment process AU";
