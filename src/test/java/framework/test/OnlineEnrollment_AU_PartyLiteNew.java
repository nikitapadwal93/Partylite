...
public class OnlineEnrollment_AU_PartyLiteNew extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_AU_PartyLiteNew() throws FileNotFoundException, IOException {
		super();
