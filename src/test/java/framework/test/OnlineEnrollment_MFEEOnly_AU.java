...
public class OnlineEnrollment_MFEEOnly_AU extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_MFEEOnly_AU() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		tcName = "AU Online Enrollment with MFEE Only";
