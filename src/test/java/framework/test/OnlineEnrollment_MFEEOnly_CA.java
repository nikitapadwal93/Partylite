...
public class OnlineEnrollment_MFEEOnly_CA extends Class_initEcomPrac{
	public String country;

	public OnlineEnrollment_MFEEOnly_CA() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOECA(@Optional String paramCountry) {
		tcName = "CA Online Enrollment with MFEE Only";
		tcDescription = "MFEE Only, payment by MasterCard";
