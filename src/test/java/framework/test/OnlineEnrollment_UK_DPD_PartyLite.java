...
public class OnlineEnrollment_UK_DPD_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_UK_DPD_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		tcName = "Online Enrollment UK with PUP";
		tcDescription = "Enrollment process UK by DPD PUP option";
	...
	public void createGuestOrder(String password,String address1,
		...
		try {
			...
			.clickAuthenticate()
					...
					/*
					 * .clickeWallet() .clickPaypalConfirm() .clickPaypalSubmit()
					 */
