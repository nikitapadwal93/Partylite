...
public class OnlineEnrollment_UK_PartyLiteNew extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_UK_PartyLiteNew() throws FileNotFoundException, IOException {
		super();
