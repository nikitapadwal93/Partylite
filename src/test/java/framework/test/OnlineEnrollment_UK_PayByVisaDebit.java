...
public class OnlineEnrollment_UK_PayByVisaDebit extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_UK_PayByVisaDebit() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		...
		tcDescription = "Add business item and placed order by Visa Debit Card";
