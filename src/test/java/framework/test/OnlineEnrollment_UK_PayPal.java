...
public class OnlineEnrollment_UK_PayPal extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_UK_PayPal() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		tcName = "UK Online Enrollment by Paypal";
		tcDescription = "UK Enrollment process";
	...
	public void createGuestOrder(String password,String address1,
		...
		try {
			...
			.clickNextProceedToPaymentOE()
					 ...
					 * .enterCardExpYear(expYear) .enterCardCVV(cardCVV)
					 */
			.getOrderNumber()
			.clickeWallet() 
			.clickPaypalConfirm() 
			//.clickPaypalSubmit() /* Old Paypal-Template functions */
			.clickLoginPaypal()
			.clickPaypalPayNow()
					/*
