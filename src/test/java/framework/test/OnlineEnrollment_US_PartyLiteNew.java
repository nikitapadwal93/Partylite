...
public class OnlineEnrollment_US_PartyLiteNew extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_US_PartyLiteNew() throws FileNotFoundException, IOException {
		super();
