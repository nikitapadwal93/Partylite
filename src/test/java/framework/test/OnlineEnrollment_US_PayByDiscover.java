...
public class OnlineEnrollment_US_PayByDiscover extends Class_initEcomPrac{
	public String country;
	
	public OnlineEnrollment_US_PayByDiscover() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		...
		tcDescription = "Add business item and placed order by Discover Card";
