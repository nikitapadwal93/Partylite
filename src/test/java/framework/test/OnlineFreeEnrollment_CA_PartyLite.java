...
public class OnlineFreeEnrollment_CA_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public OnlineFreeEnrollment_CA_PartyLite() throws FileNotFoundException, IOException {
		super();
	...
	public void setDataOEUS(@Optional String paramCountry) {
		tcName = "CA Online FREE-Enrollment";
