...
public class OnlineFreeEnrollment_US_PartyLite extends Class_initEcomPrac{
	public String country;
	
	public OnlineFreeEnrollment_US_PartyLite() throws FileNotFoundException, IOException {
		super();
